...
\name{Georgios Konstantinos}{Krintiras}
\address{The University of Kansas,  1251 Wescoe Hall Dr, Lawrence, KS 66045}
\position{PhD{\enskip\cdotp\enskip}EXPERIMENTAL ELEMENTARY PARTICLE AND NUCLEAR PHYSICS}
% \address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+1) 785-423-8460}
\email{gkrintir@cern.ch}
\homepage{cern.ch/gkrintir}
%\github{pollend}
%\linkedin{michaelpollind}
% \gitlab{gitlab-id}
